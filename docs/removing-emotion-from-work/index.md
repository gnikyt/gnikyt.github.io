...
I honestly think I entered the age of the internet at the perfect time. You had no choice but to do the hard work and learn, whether that meant building table layouts in GoLive, wiring some animated pill-button form to `FormMail.pl` in a CGI/Perl setup, adding hit counters and guestbooks to every site, fighting JavaScript differences between IE and Netscape, or trying to get your work hosted on some shared FTP/cPanel box, tinkering with the hot-new Python, and so on. There weren't many resources besides literal books in the house, and if you were lucky, an early forum where you could ask questions. No AI, no StackOverflow, no Slack or Discord, no smartphones, no instant internet access *(I still miss the dial-up sound)*.
