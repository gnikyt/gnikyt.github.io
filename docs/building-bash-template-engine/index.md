...
BASH is definately not the best solution for a template engine, however, you can view the entire solution on [my blog's repo](http://github.com/gnikyt/gnikyt.github.io/tree/master/bin/parse_tpl) and modify for your needs.
